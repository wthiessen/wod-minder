<div data-role="page">
	<div data-role="header">
		...
		<?php if (!$member_list):?>
			...
			<a href="<?php echo base_url().'administration_functions/destroy_user/'.$member_id;?>" data-ajax ="false" data-role="button" onclick="return confirm('Are you SURE about this?\nMaxes, WODs and Weight Log will be removed for this person.');">Complete erase this member and their history</a>
		<?php else :?>
			<div class="content-primary">	
